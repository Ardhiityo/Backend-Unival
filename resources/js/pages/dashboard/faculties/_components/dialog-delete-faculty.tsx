...
export default function DialogDeleteFaculty({ open, setOpen, faculty }: Props) {
    const [pending, setPending] = useState(false);

    function handleDelete() {
        setPending(true);
        router.delete(`/faculties/${faculty.id}`, {
            onSuccess: () => toast.success("Success to deleted the faculty"),
            onError: (message) => {
                if (message.general) {
            ...
            <AlertDialogContent size="sm">
                <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                        This will permanently delete {faculty.title}.
                    </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
