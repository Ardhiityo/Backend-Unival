...
export default function Page({ news }: { news: News }) {
    ...
    const onSubmit = (data: UpdateNewsForm) => {
        setPending(true);
        router.put(`/news/${news.id}`, data, {
            forceFormData: true,
            onSuccess: () => {
            ...
            onError: (errors) => {
                Object.entries(errors).forEach(([field, message]) =>
                    setError(field as keyof UpdateNewsForm, {
                        message,
                    }),
                );
            },
    ...
    return (
        <>
            ...
            <Card>
                <CardHeader>
                    <CardTitle>Form Update News</CardTitle>
                    <CardDescription>
